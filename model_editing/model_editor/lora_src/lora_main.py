...
def execute_lora(
    ...
    # seb: I ran into error: RuntimeError: Tensor on device meta is not on the expected device cuda:0! 
    #seb: hence changed to dynamic model device instead of loading from hparam
    device = lora_device
    # Define inputs
